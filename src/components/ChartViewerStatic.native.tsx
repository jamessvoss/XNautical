...
const soundgData_PG = require('../../assets/Maps/US4AK4PG_soundg.json');
...
const soundgData_QF = require('../../assets/Maps/US5AK5QF_soundg.json');
...
// US3AK12M - General chart (1:200,000 scale - largest coverage, least detailed)
const depareData_12M = require('../../assets/Maps/US3AK12M_depare.json');
const depcntData_12M = require('../../assets/Maps/US3AK12M_depcnt.json');
const soundgData_12M = require('../../assets/Maps/US3AK12M_soundg.json');
const lndareData_12M = require('../../assets/Maps/US3AK12M_lndare.json');
const lightsData_12M = require('../../assets/Maps/US3AK12M_lights.json');
const buoysData_12M = require('../../assets/Maps/US3AK12M_buoys.json');
const beaconsData_12M = require('../../assets/Maps/US3AK12M_beacons.json');
const landmarksData_12M = require('../../assets/Maps/US3AK12M_landmarks.json');
const wrecksData_12M = require('../../assets/Maps/US3AK12M_wrecks.json');
const rocksData_12M = require('../../assets/Maps/US3AK12M_rocks.json');
const obstructionsData_12M = require('../../assets/Maps/US3AK12M_obstructions.json');
const slconsData_12M = require('../../assets/Maps/US3AK12M_slcons.json');
const cblareData_12M = require('../../assets/Maps/US3AK12M_cblare.json');
const sbdareData_12M = require('../../assets/Maps/US3AK12M_sbdare.json');
const seaareData_12M = require('../../assets/Maps/US3AK12M_seaare.json');
const pipsolData_12M = require('../../assets/Maps/US3AK12M_pipsol.json');

// US4AK4OG - Approach chart (southern Cook Inlet)
const depareData_OG = require('../../assets/Maps/US4AK4OG_depare.json');
const depcntData_OG = require('../../assets/Maps/US4AK4OG_depcnt.json');
const soundgData_OG = require('../../assets/Maps/US4AK4OG_soundg.json');
const lndareData_OG = require('../../assets/Maps/US4AK4OG_lndare.json');
const lightsData_OG = require('../../assets/Maps/US4AK4OG_lights.json');
const buoysData_OG = require('../../assets/Maps/US4AK4OG_buoys.json');
const beaconsData_OG = require('../../assets/Maps/US4AK4OG_beacons.json');
const landmarksData_OG = require('../../assets/Maps/US4AK4OG_landmarks.json');
const wrecksData_OG = require('../../assets/Maps/US4AK4OG_wrecks.json');
const rocksData_OG = require('../../assets/Maps/US4AK4OG_rocks.json');
const obstructionsData_OG = require('../../assets/Maps/US4AK4OG_obstructions.json');
const slconsData_OG = require('../../assets/Maps/US4AK4OG_slcons.json');
const cblareData_OG = require('../../assets/Maps/US4AK4OG_cblare.json');
const sbdareData_OG = require('../../assets/Maps/US4AK4OG_sbdare.json');
const seaareData_OG = require('../../assets/Maps/US4AK4OG_seaare.json');
const pipsolData_OG = require('../../assets/Maps/US4AK4OG_pipsol.json');

// US5AK5PE - Harbor chart (detailed)
const depareData_PE = require('../../assets/Maps/US5AK5PE_depare.json');
const depcntData_PE = require('../../assets/Maps/US5AK5PE_depcnt.json');
const soundgData_PE = require('../../assets/Maps/US5AK5PE_soundg.json');
const lndareData_PE = require('../../assets/Maps/US5AK5PE_lndare.json');
const lightsData_PE = require('../../assets/Maps/US5AK5PE_lights.json');
const buoysData_PE = require('../../assets/Maps/US5AK5PE_buoys.json');
const beaconsData_PE = require('../../assets/Maps/US5AK5PE_beacons.json');
const landmarksData_PE = require('../../assets/Maps/US5AK5PE_landmarks.json');
const wrecksData_PE = require('../../assets/Maps/US5AK5PE_wrecks.json');
const rocksData_PE = require('../../assets/Maps/US5AK5PE_rocks.json');
const obstructionsData_PE = require('../../assets/Maps/US5AK5PE_obstructions.json');
const slconsData_PE = require('../../assets/Maps/US5AK5PE_slcons.json');
const cblareData_PE = require('../../assets/Maps/US5AK5PE_cblare.json');
const sbdareData_PE = require('../../assets/Maps/US5AK5PE_sbdare.json');
const seaareData_PE = require('../../assets/Maps/US5AK5PE_seaare.json');
const pipsolData_PE = require('../../assets/Maps/US5AK5PE_pipsol.json');

// US5AK5NF - Harbor chart (Nanwalek/English Bay)
const depareData_NF = require('../../assets/Maps/US5AK5NF_depare.json');
const depcntData_NF = require('../../assets/Maps/US5AK5NF_depcnt.json');
const soundgData_NF = require('../../assets/Maps/US5AK5NF_soundg.json');
const lndareData_NF = require('../../assets/Maps/US5AK5NF_lndare.json');
const lightsData_NF = require('../../assets/Maps/US5AK5NF_lights.json');
const buoysData_NF = require('../../assets/Maps/US5AK5NF_buoys.json');
const beaconsData_NF = require('../../assets/Maps/US5AK5NF_beacons.json');
const landmarksData_NF = require('../../assets/Maps/US5AK5NF_landmarks.json');
const wrecksData_NF = require('../../assets/Maps/US5AK5NF_wrecks.json');
const rocksData_NF = require('../../assets/Maps/US5AK5NF_rocks.json');
const obstructionsData_NF = require('../../assets/Maps/US5AK5NF_obstructions.json');
const slconsData_NF = require('../../assets/Maps/US5AK5NF_slcons.json');
const cblareData_NF = require('../../assets/Maps/US5AK5NF_cblare.json');
const sbdareData_NF = require('../../assets/Maps/US5AK5NF_sbdare.json');
const seaareData_NF = require('../../assets/Maps/US5AK5NF_seaare.json');
const pipsolData_NF = require('../../assets/Maps/US5AK5NF_pipsol.json');

// US5AK5PF - Harbor chart (Port Graham)
const depareData_PF = require('../../assets/Maps/US5AK5PF_depare.json');
const depcntData_PF = require('../../assets/Maps/US5AK5PF_depcnt.json');
const soundgData_PF = require('../../assets/Maps/US5AK5PF_soundg.json');
const lndareData_PF = require('../../assets/Maps/US5AK5PF_lndare.json');
const lightsData_PF = require('../../assets/Maps/US5AK5PF_lights.json');
const buoysData_PF = require('../../assets/Maps/US5AK5PF_buoys.json');
const beaconsData_PF = require('../../assets/Maps/US5AK5PF_beacons.json');
const landmarksData_PF = require('../../assets/Maps/US5AK5PF_landmarks.json');
const wrecksData_PF = require('../../assets/Maps/US5AK5PF_wrecks.json');
const rocksData_PF = require('../../assets/Maps/US5AK5PF_rocks.json');
const obstructionsData_PF = require('../../assets/Maps/US5AK5PF_obstructions.json');
const slconsData_PF = require('../../assets/Maps/US5AK5PF_slcons.json');
const cblareData_PF = require('../../assets/Maps/US5AK5PF_cblare.json');
const sbdareData_PF = require('../../assets/Maps/US5AK5PF_sbdare.json');
const seaareData_PF = require('../../assets/Maps/US5AK5PF_seaare.json');
const pipsolData_PF = require('../../assets/Maps/US5AK5PF_pipsol.json');
...
const DEBUG_COLORS: Record<string, string> = {
  US3AK12M: '#607D8B',  // Blue Gray - General chart (largest, least detailed)
  US4AK4PG: '#2196F3',  // Blue - Port Graham Area
  US4AK4PH: '#FF9800',  // Orange - Homer Approach
  US4AK4OG: '#795548',  // Brown - Outer Graham Approach
  US5AK5SJ: '#9C27B0',  // Purple - Seldovia/Jakolof
  US5AK5SI: '#4CAF50',  // Green - Homer Harbor
  US5AK5QG: '#F44336',  // Red - Halibut Cove
  US5AK5QF: '#00BCD4',  // Cyan - Port Graham
  US5AK5PE: '#E91E63',  // Pink - Port Graham Entrance
  US5AK5NF: '#009688',  // Teal - Nanwalek/English Bay
  US5AK5PF: '#8BC34A',  // Light Green - Port Graham Detail
};
...
const CHARTS = {
  // General chart (scale 3) - largest coverage, base layer
  US3AK12M: {
    name: 'Cook Inlet General',
    shortName: 'General',
    center: [-152.5783, 59.5524],
    scaleType: 'general',
    scale: 0,  // Base layer - largest area, least detailed
    minZoom: 0,
    scaminContour: 359999,  // 1:200000 scale
    scaminSounding: 239999,
    bounds: [-154.4092, 58.8052, -150.7449, 60.2947],
    data: {
      depare: depareData_12M,
      depcnt: depcntData_12M,
      soundg: soundgData_12M,
      lndare: lndareData_12M,
      lights: lightsData_12M,
      buoys: buoysData_12M,
      beacons: beaconsData_12M,
      landmarks: landmarksData_12M,
      wrecks: wrecksData_12M,
      rocks: rocksData_12M,
      obstructions: obstructionsData_12M,
      slcons: slconsData_12M,
      cblare: cblareData_12M,
      sbdare: sbdareData_12M,
      seaare: seaareData_12M,
      pipsol: pipsolData_12M,
    },
  },
  // Approach charts (scale 4) - more detailed
  US4AK4PG: {
    name: 'Port Graham Area',
    shortName: 'Port Graham',
    center: [-152.1000, 59.5500],
    scaleType: 'approach',
    scale: 1,  // More detailed than general
    minZoom: 0,
  ...
  US4AK4OG: {
    name: 'Port Graham to Anchor Point',
    shortName: 'Outer Graham',
    center: [-152.1000, 59.2500],
    scaleType: 'approach',
    scale: 1,
    minZoom: 0,
    scaminContour: 179999,
    scaminSounding: 119999,
    bounds: [-152.4000, 59.1000, -151.8000, 59.4000],
    data: {
      depare: depareData_OG,
      depcnt: depcntData_OG,
      soundg: soundgData_OG,
      lndare: lndareData_OG,
      lights: lightsData_OG,
      buoys: buoysData_OG,
      beacons: beaconsData_OG,
      landmarks: landmarksData_OG,
      wrecks: wrecksData_OG,
      rocks: rocksData_OG,
      obstructions: obstructionsData_OG,
      slcons: slconsData_OG,
      cblare: cblareData_OG,
      sbdare: sbdareData_OG,
      seaare: seaareData_OG,
      pipsol: pipsolData_OG,
    },
  },
  US5AK5SJ: {
  ...
  US5AK5PE: {
    name: 'Port Graham Entrance',
    shortName: 'Graham Entrance',
    center: [-152.0250, 59.3625],
    scaleType: 'harbor',
    scale: 3,
    minZoom: 12,
    scaminContour: 21999,
    scaminSounding: 17999,
    bounds: [-152.1000, 59.3250, -151.9500, 59.4000],
    data: {
      depare: depareData_PE,
      depcnt: depcntData_PE,
      soundg: soundgData_PE,
      lndare: lndareData_PE,
      lights: lightsData_PE,
      buoys: buoysData_PE,
      beacons: beaconsData_PE,
      landmarks: landmarksData_PE,
      wrecks: wrecksData_PE,
      rocks: rocksData_PE,
      obstructions: obstructionsData_PE,
      slcons: slconsData_PE,
      cblare: cblareData_PE,
      sbdare: sbdareData_PE,
      seaare: seaareData_PE,
      pipsol: pipsolData_PE,
    },
  },
  US5AK5NF: {
    name: 'Nanwalek / English Bay',
    shortName: 'English Bay',
    center: [-151.8750, 59.2125],
    scaleType: 'harbor',
    scale: 3,
    minZoom: 12,
    scaminContour: 21999,
    scaminSounding: 17999,
    bounds: [-151.9500, 59.1750, -151.8000, 59.2500],
    data: {
      depare: depareData_NF,
      depcnt: depcntData_NF,
      soundg: soundgData_NF,
      lndare: lndareData_NF,
      lights: lightsData_NF,
      buoys: buoysData_NF,
      beacons: beaconsData_NF,
      landmarks: landmarksData_NF,
      wrecks: wrecksData_NF,
      rocks: rocksData_NF,
      obstructions: obstructionsData_NF,
      slcons: slconsData_NF,
      cblare: cblareData_NF,
      sbdare: sbdareData_NF,
      seaare: seaareData_NF,
      pipsol: pipsolData_NF,
    },
  },
  US5AK5PF: {
    name: 'Port Graham Harbor Detail',
    shortName: 'Port Graham',
    center: [-151.8750, 59.3697],
    scaleType: 'harbor',
    scale: 3,
    minZoom: 12,
    scaminContour: 21999,
    scaminSounding: 17999,
    bounds: [-151.9500, 59.3394, -151.8000, 59.4000],
    data: {
      depare: depareData_PF,
      depcnt: depcntData_PF,
      soundg: soundgData_PF,
      lndare: lndareData_PF,
      lights: lightsData_PF,
      buoys: buoysData_PF,
      beacons: beaconsData_PF,
      landmarks: landmarksData_PF,
      wrecks: wrecksData_PF,
      rocks: rocksData_PF,
      obstructions: obstructionsData_PF,
      slcons: slconsData_PF,
      cblare: cblareData_PF,
      sbdare: sbdareData_PF,
      seaare: seaareData_PF,
      pipsol: pipsolData_PF,
    },
  },
};
...
// Order: least detailed (general) to most detailed (harbor)
// Scale 3 = general, Scale 4 = approach, Scale 5 = harbor
const CHART_RENDER_ORDER: ChartKey[] = [
  'US3AK12M',   // General (1:200k)
  'US4AK4PG',   // Approach - Port Graham area
  'US4AK4PH',   // Approach - Homer area
  'US4AK4OG',   // Approach - Outer Graham
  'US5AK5SJ',   // Harbor - Seldovia/Jakolof
  'US5AK5SI',   // Harbor - Homer
  'US5AK5QG',   // Harbor - Halibut Cove
  'US5AK5QF',   // Harbor - Port Graham
  'US5AK5PE',   // Harbor - Port Graham Entrance
  'US5AK5NF',   // Harbor - Nanwalek/English Bay
  'US5AK5PF',   // Harbor - Port Graham Detail
];

// Helper: Check if a point is within a chart's bounds
const isPointInBounds = (lon: number, lat: number, bounds: number[]): boolean => {
  const [minLon, minLat, maxLon, maxLat] = bounds;
  return lon >= minLon && lon <= maxLon && lat >= minLat && lat <= maxLat;
};

// Helper: Filter features to only include those NOT covered by more detailed charts
// This prevents duplicate features from showing when charts overlap
const filterForQuilting = (
  features: any[],
  currentChartKey: ChartKey,
  getFeaturePoint: (f: any) => [number, number] | null
): any[] => {
  const currentIndex = CHART_RENDER_ORDER.indexOf(currentChartKey);
  
  // Get all more detailed charts (those rendered after this one)
  const moreDetailedCharts = CHART_RENDER_ORDER.slice(currentIndex + 1);
  
  if (moreDetailedCharts.length === 0) {
    // Most detailed chart - show all features
    return features;
  }
  
  // Filter out features that fall within more detailed chart bounds
  return features.filter(f => {
    const point = getFeaturePoint(f);
    if (!point) return true; // Keep features we can't determine location for
    
    const [lon, lat] = point;
    
    // Check if this point is covered by any more detailed chart
    for (const detailedKey of moreDetailedCharts) {
      const detailedChart = CHARTS[detailedKey];
      if (isPointInBounds(lon, lat, detailedChart.bounds)) {
        // This feature is covered by a more detailed chart - exclude it
        return false;
      }
    }
    
    // Not covered by any more detailed chart - include it
    return true;
  });
};
        ...
        {showDepthAreas && CHART_RENDER_ORDER.map((chartKey) => {
          ...
          return (
            ...
            >
              ...
              />
{/* Removed depth area outlines - they create visible seams at chart boundaries */}
            </Mapbox.ShapeSource>
          );
        })}
        ...
        {/* Submarine Cable LINES (LineStrings) - the actual cable routes
            Rendered as magenta dashed lines per S-52 symbology
            NOTE: No quilting filter applied - cables are critical navigation hazards
            that span multiple charts and should always be visible */}
        {showCables && CHART_RENDER_ORDER.map((chartKey) => {
          const chart = CHARTS[chartKey];
          if (!chart.data.cblare || chart.data.cblare.features.length === 0) return null;
          
          // Filter to LineStrings only for submarine cables
          const lineFeatures = chart.data.cblare.features.filter(
          ...
          return (
            ...
            >
              <Mapbox.LineLayer
                id={`cblsub-line-${chartKey}`}
                minZoomLevel={chart.minZoom}
                style={{
                  lineColor: '#FF00FF',  // Magenta per S-52 symbology
                  lineWidth: 2,
                  lineDasharray: [8, 4],  // Dashed line
                  lineOpacity: 0.9,
                }}
        ...
        {showDepthContours && CHART_RENDER_ORDER.map((chartKey) => {
          ...
          // Filter contours for quilting - exclude those covered by more detailed charts
          const filteredContours = filterForQuilting(
            chart.data.depcnt.features || [],
            chartKey,
            (f) => {
              // Get center point of contour line
              ...
              if (f.geometry.type === 'LineString' && coords.length > 0) {
                ...
                const mid = Math.floor(coords[0].length / 2);
                return [coords[0][mid][0], coords[0][mid][1]];
              }
              return null;
            }
          );
          
          if (filteredContours.length === 0) return null;
          
          return (
            <Mapbox.ShapeSource
              key={`depcnt-${chartKey}`}
              id={`contours-source-${chartKey}`}
              shape={{ type: 'FeatureCollection', features: filteredContours }}
              minZoomLevel={chart.minZoom}
            >
              <Mapbox.LineLayer
              ...
              <Mapbox.SymbolLayer
                ...
                minZoomLevel={12}  // Only show labels at zoom 12+
                style={{
                  ...
                  textColor: '#1565C0',  // Blue for depth labels
        ...
        {showSoundings && CHART_RENDER_ORDER.map((chartKey) => {
          ...
          // Filter soundings for quilting - exclude those covered by more detailed charts
          const filteredSoundings = filterForQuilting(
            chart.data.soundg.features || [],
            chartKey,
            (f) => {
              const coords = f.geometry?.coordinates;
              if (!coords || f.geometry.type !== 'Point') return null;
              return [coords[0], coords[1]];
            }
          );
          
          if (filteredSoundings.length === 0) return null;
          
          return (
            <Mapbox.ShapeSource
              key={`soundg-${chartKey}`}
              id={`soundings-source-${chartKey}`}
              shape={{ type: 'FeatureCollection', features: filteredSoundings }}
              minZoomLevel={chart.minZoom}
            >
              <Mapbox.SymbolLayer
                id={`soundings-${chartKey}`}
                minZoomLevel={11}  // Show soundings at zoom 11+
                style={{
        ...
        {showHazards && CHART_RENDER_ORDER.map((chartKey) => {
          ...
          // Filter rocks for quilting
          const filteredRocks = filterForQuilting(
            chart.data.rocks.features,
            chartKey,
            (f) => {
              const coords = f.geometry?.coordinates;
              if (!coords || f.geometry.type !== 'Point') return null;
          ...
          return (
            <Mapbox.ShapeSource
              ...
              shape={{ type: 'FeatureCollection', features: filteredRocks }}
              minZoomLevel={chart.minZoom}
              hitbox={{ width: 44, height: 44 }}
              onPress={(e) => {
                if (e.features && e.features.length > 0) {
        ...
        {showLights && CHART_RENDER_ORDER.map((chartKey) => {
          ...
          // Filter lights for quilting
          const filteredLights = filterForQuilting(
            chart.data.lights.features || [],
            chartKey,
            (f) => {
              const coords = f.geometry?.coordinates;
              if (!coords || f.geometry.type !== 'Point') return null;
          ...
          if (filteredLights.length === 0) return null;
          
          return (
            <Mapbox.ShapeSource
              key={`lights-${chartKey}`}
              id={`lights-source-${chartKey}`}
              shape={{ type: 'FeatureCollection', features: filteredLights }}
              minZoomLevel={chart.minZoom}
              hitbox={{ width: 44, height: 44 }}
              onPress={(e) => {
